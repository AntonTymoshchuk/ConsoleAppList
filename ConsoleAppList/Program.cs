...
using static ConsoleAppList.Program;
...
namespace ConsoleAppList
{
    class Program
    {
        ...
        //    try { Console.WriteLine("Installed Location: {0}", package.InstalledLocation.Path); }
        //    catch { Console.WriteLine("Installed Location : Error"); }

        //    Console.WriteLine("IsFramework: {0}", package.IsFramework);

        //    Console.WriteLine("ImagePath: {0}", ExtractDisplayName());
        ...
        {
            if (package.FullName.Contains("OneNote"))
                Console.WriteLine("--------------------------------------------------------");
